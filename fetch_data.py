...
"is_alien_or_god": 1.0 if any(k in species for k in ["alien", "god", "kryptonian", "martian", "asgardian", "new god"]) else 0.0,
...
"skin_non_human": 1.0 if any(k in skin for k in ["green", "blue", "metal", "purple", "stone", "chalk", "gold"]) else 0.0,
...
"uses_energy_blasts": 1.0 if any(k in powers_desc for k in ["blast", "beam", "laser", "projectile", "lightning", "energy"]) else 0.0,
"wears_powered_armor": 1.0 if "armor" in weapon or "suit" in weapon else 0.0,
"wields_bladed_weapon": 1.0 if any(k in weapon for k in ["sword", "katana", "claws", "blade", "daggers"]) else 0.0,
